...
import aboutMeBanner from "../../assets/about_me_banner.png";
import myPhoto from "../../assets/my_photo.png";

const About = () => {
  return (
    <PostModel banner={aboutMeBanner} title="Sobre mim">
      <h3 className={styles.subtitle}>Olá, eu sou o Antônio!</h3>
